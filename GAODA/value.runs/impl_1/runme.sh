...
HD_PWD='C:/Users/feiya/Desktop/GAODA/GAODA/value.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GAODA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GAODA.tcl -notrace
