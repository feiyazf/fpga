...
HD_PWD='C:/Users/feiya/Desktop/GAODA/GAODA/value.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GAODA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GAODA.tcl
